...
function showSection(id) {
  ...
  // =====================
  // Quiz data
  // Each lesson has 2–3 simple questions
  // =====================
  ...
  function gradeQuiz(lessonId, container) {
    ...
    if (score === total) {
      resultDiv.textContent += " Excellent! You understand this lesson well.";
    } else if (score >= total / 2) {
      resultDiv.textContent += " Good job! You may review the lesson once more.";
    } else {
      resultDiv.textContent += " Consider rereading the lesson and trying again.";
    }
  }
